...
insert into fingerlings(description, f_name, script, function_user, tags, dependencies) 
	values 	('Pio Calcu', 'calcular', 'function calcular(a, b, sym){let calc;if(sym == "+"){calc = suma(a, b);}return calc;}', 'ppuvvNOG27UvG1zK7T7dATZpSR12', Array['math'], Array[2]),
		('Pio Calcu', 'suma', 'function suma(a, b){return a+b;}', 'ppuvvNOG27UvG1zK7T7dATZpSR12', Array['math'], null);
